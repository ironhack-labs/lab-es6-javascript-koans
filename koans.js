...
describe('`string.includes()` finds string within another string. ', () => {
  ...
  describe('find a string', function() {
    it('that matches exactly', function() {
      /* const findSome = "xyz" => 'xyz'.includes(findSome);*/
...
describe('destructuring function parameters. ', () => {
  ...
  describe('destruct parameters', () => {
    it('multiple params from object', () => {
      const fn = (id, name) => {return 42, 'Wolfram';
  ...
  describe('default values', () => {
    it('for simple values', () => {
      const fn = (id, name) => { return 23, 'Bob';
    ...
    it('for a missing array value', () => {
      ...
      const fn = ([user]) => { return defaultUser;
    ...
    it('mix of parameter types', () => {
      const fn = (id, [arr], {obj}) => { return 1, 2, 3;
        expect(id).toEqual(1);
