...
describe('`string.includes()` finds string within another string. ', () => {
  ...
  describe('find a string', function() {
    it('that matches exactly', function() {
      let findSome = (s)=>"xyz".includes("xyz")
...
describe('destructuring objects. ', () => {
  ...
  it('is simple', () => {
    const x = {x:1};
    expect(Number(Object.values(x))).toEqual(1);
  });

  describe('nested', () => {
    it('multiple objects', () => {
      const magic = {first: 23, second: 42};
      const [first, second]=Object.values(magic)
...
describe('rest with destructuring', () => {
  ...
  it('assign rest of an array to a variable', () => {
    const all = [1, 2, 3, 4];
    expect(all.slice(1,4)).toEqual([2, 3, 4]);
  });
});
...
describe('spread with arrays. ', () => {
  ...
  it('in combination with rest', function() {
    ...
    expect(rest.slice(1,4)).toEqual([3, 4, 5]);
  });

  it('spreading into the rest', function() {
    const [...rest] = [...[,1, 2, 3, 4, 5]];
    expect(rest.slice(1,6)).toEqual([1, 2, 3, 4, 5]);
  });
...
describe('spread with strings', () => {
  ...
  it('works anywhere inside an array (must not be last)', function() {
    ...
    expect(letters.join("").length).toEqual(6);
  });
