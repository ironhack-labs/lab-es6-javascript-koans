...
describe("arrow functions. ", () => {
  ...
  describe("arrow functions have lexical `this`, no dynamic `this`", () => {
    ...
    it("can NOT bind a different context", function () {
      ...
      //Este no lo termino de comprender bien
...
describe("destructuring function parameters. ", () => {
  ...
  describe("default values", () => {
    ...
    it("mix of parameter types", () => {
      const fn = (id = one, [arr = two], { obj = three }) => {
        expect(id).toEqual(1);
      ...
      //Tambien podriamos colocar directamente los valores en los parametros de la funcion
      fn(void 0, [], {});
    });
  });
});
...
describe("assign object property values to new variables while destructuring. ", () => {
  describe("for simple objects", function () {
    ...
    it("assign a new name and give it a default value using `= <default value>`", () => {
      //const { x, y = 42 } = { x: 23 };// No entiendo bien si es de esta forma
      const { x: y = 42} = { y: 23}// O de esta otra
      expect(y).toEqual(42);
    });
  });
