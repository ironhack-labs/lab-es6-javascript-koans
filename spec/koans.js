...
describe('`const` is like `let` plus read-only. ', () => {
  ...
  describe('scalar values are read-only', () => {
    it('number are read-only', () => {
      const constNum = 0;
      // constNum = 1;    // this throws error if uncommented
    ...
    it('string are read-only', () => {
      ...
      // constString = "Cant change you?";    // this throws error if uncommented
...
describe('spread with arrays. ', () => {
  ...
  describe('used as function parameter', () => {
    it('prefix with `...` to spread as function params', function() {
      const magicNumbers = [];
      const fn = ([...[magicA, magicB]]) => {     // this is not necessary though, just [magicA, magicB] works
