...
describe('`string.includes()` finds string within another string. ', () => {
  ...
  describe('find a single character', function() {
    ...
    it('reports false if character was not found', function() {
      const expected = 'u';
      expect('xyz'.includes(expected)).toBe(false);
    });
  });
  ...
  describe('takes a position from where to start searching', function() {
    ...
    describe('invalid positions get converted to 0', function() {
      it('e.g. `undefined`', function() {
        const findAtPosition = (pos=0) => 'xyz'.includes(pos) ? false : true;
      ...
      it('NaN', function() {
        const findAtPosition = (pos) => 'xyz'.includes() ? false : true;
...
describe('arrow functions. ', () => {
  ...
  it('one parameter can be written without parens', () => {
    let func = parameter => parameter-1 ;
    expect(func(25)).toEqual(24)
  });

  it('many params require parens', () => {
    let func = (parameter1,parameter2) => parameter1+parameter2;
...
describe('class creation', () => {
  ...
  it('multiple methods need no commas (opposed to object notation)', function() {
    class User {
      ...
      isLazy()     { this.everWroteATest = true; }
    }
