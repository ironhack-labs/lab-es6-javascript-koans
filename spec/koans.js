...
describe('`string.includes()` finds string within another string. ', () => {
  ...
  describe('find a string', function() {
    it('that matches exactly', function() {
      ...
      const findSome = findSomeOther => findSomeOther.includes('xyz')
  ...
  describe('takes a position from where to start searching', function() {
    ...
    describe('invalid positions get converted to 0', function() {
      ...
      it('NaN', function() {
        const findAtPosition = (pos) => 'xyz'.includes('', NaN);
...
// I KNOW THE CORRECT ANSWER TO THIS, BUT I DON'T UNDERSTAND WHY IT IS 6?
...
// I DON'T UNDERSTAND THIS ONE AT ALL. WOULD LIKE TO HAVE SOME FEEDBACK ON IT
