...
describe('`string.includes()` finds string within another string. ', () => {
  ...
  describe('find a string', function() {
    it('that matches exactly', function() {
      // const findSome = 'xyzwd' => 'xyz'.includes();
  ...
  describe('search for an empty string, is always true', function() {
    it('in an empty string', function() {
       const x=''// no lo entiendo, no deberia ser al reves?
  ...
  describe('takes a position from where to start searching', function() {
    ...
    });//no entiendo muy bien por que puedes meter cualquier letra 
    ...
    describe('invalid positions get converted to 0', function() {
      ...
      it('negative numbers', function() {
        const findAtPosition = (pos) => 'xyz'.includes('xy'); 
        expect(findAtPosition(-2)).toBe(true);
      });
      it('NaN', function() {
        const findAtPosition = (pos) => 'xyz'.includes('yz'); 
...
describe('destructuring arrays makes shorter code. ', () => {
  ...
  it('extract value from array, e.g. extract 0 into x like so `let [x] = [0];`', () => {
    let [firstValue] = [1];//no tendiendo muy bien los parentesis del first value
  ...
  it('leading commas', () => {
    ...
    const [,,z] = all;//lo entiendo pero me cuesta llegar a ello
  ...
  it('extract from nested arrays', () => {
    ...
    const expected = `${firstName} ${surname} = ${age} years`;//IMPORTANTE !
...
describe('destructuring also works on strings. ', () => {
  ...
  it('destructure every character', () => {
    let [a, b, c] = 'abc';//crearia 3 lets con una letra cada uno. correcto?
...
describe('destructuring objects. ', () => {
  ...
  it('is simple', () => {//revisar respecto al original
    const expected = {x: 1};
    const {x} = expected;
  ...
  describe('nested', () => {
    it('multiple objects', () => {
      ...
      const {second}  = magic; // revisar para entender mejor
      expect(second).toEqual(42);
    });
    it('object and array', () => {
      //revsar para entender mejor... no lo he usado esta linea, cuando creo que deberia
      // const {z:x} = {z: [23, 42]}; 
      const [z,x] = [23, 42];
      expect(x).toEqual(42);
    });
  ...
  describe('interesting', () => {
    it('missing refs become undefined', () => {
      // const z = {x: 1, y: 2};
      const {x,y,z} = {x: 1, y: 2};//encuentra la y y la z como variables, pero no la z por que no esta en el objeto
...
describe('destructuring can also have default values. ', () => {
  ...
  it('for an empty array', () => {
    const [a=1] = [];//entiendo el concepto pero... no le veo mucho sentido, los de abajo funcionan igual
    expect(a).toEqual(1)
  });
...
describe('arrow functions. ', () => {
  ...
  it('body needs parens to return an object', () => {
    let func = () => ({iAm: 'an object'})//tip importante
  ...
  describe('arrow functions have lexical `this`, no dynamic `this`', () => {
    ...
    it('`arguments` doesnt work inside arrow functions', function() {
      let bound = new LexicallyBound();
      let fn = boundgetArgumentsFunction();
...
describe('destructuring function parameters. ', () => {
  ...
  describe('default values', () => {
    ...
    it('for a missing array value', () => {
      ...
      const fn = ([user=defaultUser]) => {//curioso..
    ...
    it('mix of parameter types', () => {
      ...
      fn(void 0, [2], {obj:3});//darle un ojo, no termino de entenderlo...
    });
  });
...
describe('assign object property values to new variables while destructuring. ', () => {
  ...
  describe('for function parameter names', function() {
    it('do it the same way, with a colon behind it', () => {
      const fn = ({x,y}) => {//me sale pero lo veo lioso
       expect(y).toEqual(1);
      };
      fn({x: 1,y: 1});
    });
...
describe('rest with destructuring', () => {
  ...
  it('assign rest of an array to a variable', () => {
    const [y,...all] = [1, 2, 3, 4];//aqui meto el numero que no quiero en otro lado
...
describe('spread with arrays. ', () => {
  ...
  it('extracts each array item', function() {
    const [a,b] = [...[1, 2]];//no entiendo bien por que pasa de los numeros suspensivos
  ...
  it('in combination with rest', function() {
    ...
    expect(a).toEqual(1);
    expect(b).toEqual(2);
    expect(rest).toEqual([3, 4, 5]);//darle un ojo
  });

  it('spreading into the rest', function() {
    const [z,...rest] = [...[,1, 2, 3, 4, 5]];
  ...
  describe('used as function parameter', () => {
    it('prefix with `...` to spread as function params', function() {
      ...
      const fn = ([magicA, magicB]) => {
        expect(magicNumbers[0]).toEqual(magicA);//da igual descomentarlo?
        expect(magicNumbers[1]).toEqual(magicB);//da igual descomentarlo?
      };
      fn(magicNumbers);
    });
  });
...
describe('class creation', () => {
  ...
  it('defining a method is simple', function() {//darle un ojo
    class User {
  ...
  it('anonymous class', () => {
    const classType = typeof class{};//darle un ojo
