...
describe('arrow functions. ', () => {
  ...
  it('body needs parens to return an object', () => {
    let func = () => ({iAm: 'an object'}); // WHY??
    expect(func()).toEqual({iAm: 'an object'});
  });

  class LexicallyBound { // constructor
...
describe('destructuring arrays makes shorter code. ', () => {
  ...
  it('swap two variables, in one operation', () => { // Why does this work?
    let [x, y] = ['ax', 'why'];
    [x, y] = [y, x];
    expect([x, y]).toEqual(['why', 'ax']);
  });
  
  it('leading commas', () => { // What does leading commas mean?!
