...
describe('destructuring objects. ', () => {
  ...
  describe('nested', () => {
    ...
    it('array and object', () => {
      const [x, [{env, lang}]] = [null, [{env: 'browser', lang: 'ES6'}]];
...
describe('assign object property values to new variables while destructuring. ', () => {
  ...
  describe('for simple objects', function() {
    ...
    it('assign a new name and give it a default value using `= <default value>`', () => { // ------------------------------------------ look it !
      const {x : y= 42} = {y: 23};
      expect(y).toEqual(42);
    });
  });
...
describe('spread with arrays. ', () => {
  ...
  describe('used as function parameter', () => { // ------------------------------------------ look it !
...
describe('class creation', () => {
  ...
  it('multiple methods need no commas (opposed to object notation)', function() { // ------------------------------------------ look it !
    class User {
  ...
  it('anonymous class', () => {
    const classType = typeof class {};// ------------------------------------------ look it !
