...
describe('destructuring objects. ', () => {
  ...
  describe('nested', () => {
    ...
    it('array and object', () => {
      const [p, [{env,lang}]]= [null, [{env: 'browser', lang: 'ES6'}]];
...
writesTests(){
  ...
  it('anonymous class', () => {
    const classType = typeof class anonymousClass{};
