  ...
  describe('takes a position from where to start searching', function() {
    ...
    describe('invalid positions get converted to 0', function() {
      it('e.g. `undefined`', function() {
        /*const findAtPosition = (pos) => 'xyz'.includes(?????); */
     const findAtPosition = (pos) =>{if(pos<0||pos>2||typeof pos!=="number") pos=0; return  'xyz'.includes("xyz"[pos]);}; 
      ...
      it('NaN', function() {
        /* const findAtPosition = (pos) => 'xyz'.includes(?????); */
        const findAtPosition = (pos) => {if(pos<0||pos>2||typeof pos!=="number"||isNaN(pos)) pos=0; return  'xyz'.includes("xyz"[pos]);}; 
