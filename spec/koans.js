...
describe('`const` is like `let` plus read-only. ', () => {
  ...
  describe('scalar values are read-only', () => {
    it('number are read-only', () => {
      const constNum = 0;
      // constNum = 1; // No se puede editar una variable const
    ...
    it('string are read-only', () => {
      ...
      // constString = "Cant change you?"; // No se puede editar una variable const
...
describe('destructuring function parameters. ', () => {
  ...
  describe('destruct parameters', () => {
    ...
    // No se cual es la solucion correcta...
    // it('multiple params from array/object', () => {
    //   const fn = (name) => {
    //     expect(name).toEqual('Alice');
    //   };
    //   const [,{name}] = [{name: 'nobody'}, {name: 'Alice', id: 42}];
    //   fn(name);
    // });
  });
  ...
  describe('default values', () => {
    ...
    it('for a missing array value', () => {
      ...
      fn(defaultArgument = [defaultUser]);
    });
