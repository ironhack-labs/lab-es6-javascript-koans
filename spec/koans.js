...
describe('`string.includes()` finds string within another string. ', () => {
  describe('find a single character', function() {
    it('in a three char string', function() {
      ...
      'xyz'.includes(searchString)
      expect('xyz'.includes(searchString)).toBe(true)
      //expect('xyz'.includes(searchString)).toBe(true);
    })
    it('reports false if character was not found', function() {
      /* const expected = ????*/
      const expected = 'xyz'.includes('abc')
  ...
  describe('find a string', function() {
    it('that matches exactly', function() {
      ...
      const findSome = some => 'xyz'.includes(some)
...
describe('destructuring can also have default values. ', () => {
  it('for an empty array', () => {
    // const [a] = []
    // const [a=1] = [] (otra posible solucion)
    const [a] = [1]
    expect(a).toEqual(1)
  })
...
describe('arrow functions. ', () => {
  it('are shorter to write', function() {
    let func = () => {
      return 'I am func' //coorect answer
      /*........*/
    }
  ...
  it('one parameter can be written without parens', () => {
    /* let func = ........;*/
    let func = num => num - 1 //correct answer
  ...
  class LexicallyBound {
    getFunction() {
      return () => {
        ...
        return this // lleva ; despues de this
        LexicallyBound() /*changes might go here*/
      }
    }
  ...
  describe('arrow functions have lexical `this`, no dynamic `this`', () => {
    ...
    it('can NOT bind a different context', function() {
      ...
      let expected = (anotherObj = bound) //change this
