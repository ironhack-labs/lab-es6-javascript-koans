  ...
  describe('takes a position from where to start searching', function() {
    ...
    describe('invalid positions get converted to 0', function() {
      it('e.g. `undefined`', function() {
        const findAtPosition = pos => 'xyz'.includes('xyz'); //funciona con cualquiera de las tres letras
        expect(findAtPosition(void 0)).toBe(true);
      });
      it('negative numbers', function() {
        const findAtPosition = pos => 'xyz'.includes('x'); //de nuevo, funciona con cualquiera de las tres
        expect(findAtPosition(-2)).toBe(true);
      });
      it('NaN', function() {
        const findAtPosition = pos => 'xyz'.includes('y'); //again
...
// en este Koan de aquí arriba no he hecho nada. Me lo he mirado, me ha parecido que funcionaría, y ha funcionado...
