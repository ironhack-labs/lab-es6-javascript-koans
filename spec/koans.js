...
describe("`let` restricts the scope of the variable to the current block - ", () => {
  describe("`let` vs. `var`.", () => {
    it("`var` works as usual, it does not restricts scope", () => {
      ...
      //el scope de var tambien aplica fuera
    });
    ...
    it("`let` restricts scope to inside the block", () => {
      ...
      //si la defines dentro del bucle con let, solo vive dentro de ese bucle
...
describe("`const` is like `let` plus read-only. ", () => {
  describe("scalar values are read-only", () => {
    it("number are read-only", () => {
      const constNum = 0;
      //   constNum = 1;
      //da error al intentar asignar otro valor a constNum, por haber sido
      //declarado con un cost
  ...
  describe("complex types are NOT fully read-only", () => {
    it("arrays is not fully read-only", () => {
      ...
      arr[0] = 0;
      expect(arr[0]).toBe(0);
      //con los array, const funciona diferente => mientras la asignación siga
      //siendo un array, funciona.
    });
...
describe("arrow functions. ", () => {
  ...
  class LexicallyBound {
    ...
    //al poner return this => está guardando el contexto de antes de la definición
    //por lo que le pasa el objeto
  ...
  describe("arrow functions have lexical `this`, no dynamic `this`", () => {
    ...
    it("`arguments` doesnt work inside arrow functions", function() {
      ...
      //quitar {} de arguments porque sino devuelve un objeto
  ...
  describe("takes a position from where to start searching", function() {
    ...
    describe("invalid positions get converted to 0", function() {
      ...
      it("negative numbers", function() {
        const findAtPosition = pos => "xyz".includes("", pos);
        expect(findAtPosition(-2)).toBe(true);
        //con negativo empieza desde arr.length - pos
      });
      it("NaN", function() {
        const findAtPosition = pos => "xyz".includes("", pos);
...
describe("The object literal allows for new shorthands. ", () => {
  ...
  describe("with variables", () => {
    it("the short version for `{y: y}` is {y}", () => {
      ...
      //con ES6, si no pones y:y, te pone por defecto que el atributo
      //se llame igual que la variable
