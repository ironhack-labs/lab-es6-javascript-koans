  ...
  describe('takes a position from where to start searching', function () {
    ...
    describe('invalid positions get converted to 0', function () {
      it('e.g. `undefined`', function () {
        const findAtPosition = (pos) => 'xyz'.includes('xyz'); //por qué???
...
describe('destructuring objects. ', () => {
  ...
  describe('nested', () => {
    it('multiple objects', () => {
      ...
      /*const first, second  = ??????*/
      expect(magic.second).toEqual(42); // --------- DUDAS 
    });
    it('object and array', () => {
      const { z: x } = { z: [23, 42] };
      expect(x[1]).toEqual(42); // ---------------- MAS DUDAS
    });
    it('array and object', () => {
      const lang = [null, [{ env: 'browser', lang: 'ES6' }]];
      expect(lang[1][0].lang).toEqual('ES6'); // ----------- MAS DUDAS
    });
  });
  ...
  describe('interesting', () => {
    it('missing refs become undefined', () => {
      const z = { x: 1, y: 2 };
      expect(z.z).toEqual(void 0); // ---------- MAS DUDAS
    });
  });
...
describe('arrow functions. ', () => {
  ...
  it('are shorter to write', function () {
    let func = () => 'I am func'; // con corchetes ni funciona
  ...
  class LexicallyBound {
    ...
    getFunction() {
      return () => {
        return new LexicallyBound().bind(); /*changes might go here*/
      };
    }
