...
describe('`string.includes()` finds string within another string. ', () => {
  ...
  describe('find a string', function() {
    it('that matches exactly', function() {
      const findSome = (i) => 'xyz'.includes(i);
...
describe('a template string, is wrapped in ` (backticks) instead of \' or ". ', () => {
  ...
  describe('can evaluate variables, which are wrapped in "${" and "}"', function() {
    ...
    it('e.g. a simple variable "${x}" just gets evaluated', function() {
      let evaluated = `x=${x}`   //checar porque es asi
      expect(evaluated).toBe('x=' + x );
    });

    it('multiple variables get evaluated too', function() {
      var evaluated = `${x}+${y}`;
      expect(evaluated).toBe(x + '+' + y); // checar el funcionamiento de esta
    });
  ...
  describe('can evaluate any expression, wrapped inside "${...}"', function() {
    ...
    it('inside "${...}" can also be a function call', function() {
      ...
      var evaluated = `${getSchool()}`; // todo:checar el funcionamiento de esta
...
describe('arrow functions. ', () => {
  ...
  describe('arrow functions have lexical `this`, no dynamic `this`', () => {
    // checar esta funcion no leentiendo
...
describe('class creation', () => {
  ...
  it('multiple methods need no commas (opposed to object notation)', function() {
    class User {
      ...
      isLazy()     { if (this.everWroteATest) return false;
        return true; }
    }
