...
describe('`let` restricts the scope of the variable to the current block - ', () => {
  describe('`let` vs. `var`.', () => {
    ...
    it('`let` restricts scope to inside the block', () => {
      letX= false/*var or const? letX = false*/
      if (true) {
      let = true  /*var or const? letX = true*/
      }
...
describe('`string.includes()` finds string within another string. ', () => {
  ...
  describe('find a string', function() {
    it('that matches exactly', function() {
      const findSome = e => 'xyz'.includes(e);
...
describe('destructuring arrays makes shorter code. ', () => {
  ...
  it('extract from nested arrays', () => {
   ...
   // const [firstName, surname, age] = user;
    const [firstName, surname, age] = [].concat(...user)
...
describe('arrow functions. ', () => {
  ...
  class LexicallyBound {
    ...
    getFunction() {
      return () => {
        return this//new LexicallyBound(); /*changes might go here*/
      };
    }
  ...
  describe('arrow functions have lexical `this`, no dynamic `this`', () => {
    ...
    it('can NOT bind a different context', function() {
      ...
      let fn = bound.getFunction();
      let anotherObj = {};
      let expected = bound//anotherObj; //change this
    ...
    it('`arguments` doesnt work inside arrow functions', function() {
      ...
      //expect(fn(1, 2).length).toEqual(0); // no endiendo que se requiere
    });
...
describe('class creation', () => {
  ...
  it('multiple methods need no commas (opposed to object notation)', function() {
    ...
    tester.wroteATest();
    //expect(tester.isLazy()).toBe(false); // no entiendo que se requiere
  });
