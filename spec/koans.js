...
describe('`string.includes()` finds string within another string. ', () => {
  ...
  describe('find a string', function() {
    it('that matches exactly', function() {
      //const findSome = => 'xyz'.includes();                     //Sin hacer
...
describe('The object literal allows for new shorthands. ', () => {
  ...
  describe('with variables', () => {
    it('the short version for `{y: y}` is {y}', () => {
      let short = new Object({ y : 2})
      expect(short).toEqual({y: y});
    });
    it('works with multiple variables too', () => {
      let short = Object({x:1, y:2})
  ...
  describe('with methods', () => {
    ...
    it('using the name only uses it as key', () => {
      let short = Object({func: func})
      expect(short).toEqual({func: func});
    });

    it('a different key must be given explicitly, just like before ES6', () => {
      let short = Object({otherKey: func})
...
describe('destructuring arrays makes shorter code. ', () => {
  ...
  it('leading commas', () => {
    const all = ['zet', 'why', 'ax'];
    const [z] = all;
    expect(z).toEqual('zet');
  });

  it('extract from nested arrays', () => {
    //const user = [['Some'+' '+ 'One'], 23];              Sin hacer
...
describe('arrow functions. ', () => {
  ...
  it('a single expression, without curly braces returns too', function() {
    let func = () => {return('I return too')};
    expect(func()).toBe('I return too');
  });

  it('one parameter can be written without parens', () => {
    let func = (n) => {return n-1} 
  ...
  describe('arrow functions have lexical `this`, no dynamic `this`', () => {
    ...
    it('bound at definition time, use `=>` ', function() {                //Sin hacer
