...
describe("`string.includes()` finds string within another string. ", () => {
  ...
  describe("find a string", function () {
    it("that matches exactly", function () {
      ...
      const findSome = (someString) => "xyz".includes(someString);
  ...
  describe("takes a position from where to start searching", function () {
    // NOT SURE ABOUT THE SOLUTIONS IN THIS SECTION
    ...
    describe("invalid positions get converted to 0", function () {
      ...
      it("negative numbers", function () {
        /*const findAtPosition = (pos) => 'xyz'.includes(????); */
        const findAtPosition = (pos) => "xyz".includes("z", pos * -1);
        expect(findAtPosition(-2)).toBe(true);
      });
      it("NaN", function () {
        /* const findAtPosition = (pos) => 'xyz'.includes(?????); */
...
describe("arrow functions. ", () => {
  ...
  describe("arrow functions have lexical `this`, no dynamic `this`", () => {
    ...
    it("can NOT bind a different context", function () {
      ...
      let expected = bound; // IS THIS THE CORRECT SOLUTION??
  ...
  describe("used as function parameter", () => {
    it("prefix with `...` to spread as function params", function () {
      ...
      const fn = ([magicA, magicB]) => {
        expect(magicNumbers[0]).toEqual(magicA); // passed without any doing on my end?!
        expect(magicNumbers[1]).toEqual(magicB); // passed without any doing on my end?!
      };
      fn(magicNumbers);
    });
  });
...
describe("class creation", () => {
  ...
  it("multiple methods need no commas (opposed to object notation)", function () {
    class User {
      ...
      isLazy() {
        return this.everWroteATest ? false : true;
      }
    }
