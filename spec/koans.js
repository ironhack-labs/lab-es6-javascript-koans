  ...
  describe('takes a position from where to start searching', function() {
    ...
    describe('invalid positions get converted to 0', function() {
      it('e.g. `undefined`', function() {
        ...
        expect(findAtPosition(void 0)).toBe(true); // qué hace void? nada?
      });
...
describe('destructuring arrays makes shorter code. ', () => {
  ...
  it('extract value from array, e.g. extract 0 into x like so `let [x] = [0];`', () => {
    let [firstValue] = [1]; // por qué se tiene que poner en corchetes el nombre de la variable?
...
describe('arrow functions. ', () => {
  ...
  it('body needs parens to return an object', () => {
    let func = () => ({iAm: 'an object'}) // se encierra entre paréntesis si se quiere retornar objeto
  ...
  describe('arrow functions have lexical `this`, no dynamic `this`', () => {
    ...
    it('can NOT bind a different context', function() {
      ...
      let fn = bound.getFunction();
      let anotherObj = {};
      let expected = bound // no entendí ggtl
