...
describe('destructuring objects. ', () => {
  ...
  describe('nested', () => {
    ...
    it('array and object', () => {
      const lan = {env: 'browser', lang: 'ES6'};
      const {lang} = lan
...
describe('arrow functions. ', () => {
  ...
  class LexicallyBound {
    ...
    getFunction() {
      return () => {
        // en lugar de devolver un nuevo objeto, se devuelve el objeto mismo con this?
        return this;
      };
    }

    getArgumentsFunction() {
      // se cambia por un arrow function, porque era una funcion normal
  ...
  describe('arrow functions have lexical `this`, no dynamic `this`', () => {
    ...
    it('can NOT bind a different context', function() {
      ...
      let fn = bound.getFunction();
      let anotherObj = {};
      // lo esperado es el mismo objeto ligado con this?
      let expected = bound; 
...
describe('class creation', () => {
  ...
  it('multiple methods need no commas (opposed to object notation)', function() {
    class User {
      ...
      isLazy()     {if(this.everWroteATest) return false; return true}
    }
