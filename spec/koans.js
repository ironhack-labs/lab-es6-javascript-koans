...
describe('`string.includes()` finds string within another string. ', () => {
  ...
  describe('find a string', function() {
    it('that matches exactly', function() {  //xyz es un array (o estring) y findSome es una funcion
      const findSome = findMe => 'xyz'.includes(findMe); // Find me es el parámetro y el derecho es el return
