...
describe('`const` is like `let` plus read-only. ', () => {
    ...
    describe('scalar values are read-only', () => {
        it('number are read-only', () => {
            const constNum = 0;
            // constNum = 1;
            // The line above stays commented because we cannot assign to a constant variable.
        ...
        it('string are read-only', () => {
            ...
            // Same here: we cannot reassign a constant.
...
describe('class creation', () => {
    ...
    it('anonymous class', () => {
        const classType = typeof class Class {};
