...
describe("`const` is like `let` plus read-only. ", () => {
  describe("scalar values are read-only", () => {
    it("number are read-only", () => {
      const constNum = 0;
      // constNum = 1; If I uncomment this one code doesnt work because you cant update asign another value to a constant
    ...
    it("string are read-only", () => {
      ...
      // constString = "Cant change you?"; If I uncomment this one code doesnt work because you cant update asign another value to a constant
