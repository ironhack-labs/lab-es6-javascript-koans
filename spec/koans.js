...
describe('`string.includes()` finds string within another string. ', () => {
  ...
  describe('find a string', function() {
    it('that matches exactly', function() {
      const findSome = el => 'xyz'.includes('xyz');
...
describe('destructuring objects. ', () => {
  ...
  describe('nested', () => {
    ...
    // it('array and object', () => {
    //   const [null, [{env, lang}]] = [null, [{env: 'browser', lang: 'ES6'}]];
...
// NOT AN ARROW FUNCTION : NEED TO DEFINE THIS
    // getFunction() {
    //   return() {
    //     let that = this;
...
describe('class creation', () => {
  ...
  it('anonymous class', () => {
    const classType = new class { 
        functionInAnonymousClass() { typeof this.wroteATest; } 
      }
