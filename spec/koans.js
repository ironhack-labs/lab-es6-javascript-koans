...
describe('`let` restricts the scope of the variable to the current block - ', () => {
  describe('`let` vs. `var`.', () => {
    ...
    it('`let` restricts scope to inside the block', () => {
      ...
      if (true) {
       constX= true /*var or const? letX = true*/
      }
...
describe('`string.includes()` finds string within another string. ', () => {
  ...
  describe('find a single character', function() {
    it('in a three char string', function() {
      /* const searchString = ???? */
      const searchString =  "x"   //.includes("xyz");
  ...
  describe('find a string', function() {
    it('that matches exactly', function() {
      const findSome = parameter => 'xyz'.includes();
      /* const findSome = .... => 'xyz'.includes();*/
        // function findSome(par) {
        // return "xyz".includes(par)
        //   }
      
      const findSome = sentence.includes('z')
