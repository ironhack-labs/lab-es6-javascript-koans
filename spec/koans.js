...
describe('`string.includes()` finds string within another string. ', () => {
    ...
    describe('find a string', function () {
        it('that matches exactly', function () {
            const findSome = (olaJavi) => olaJavi.includes('xyz');
    ...
    describe('search for an empty string, is always true', function () {
        it('in an empty string', function () {
            /* .... */
            let x = '';
            expect('porqueOmarNoTieneBArba'.includes(x)).toBe(true);
        });
        it('in `abc`', function () {
            /* .... */
            let x = 'abc'
            expect('abc Omarzin'.includes(x)).toBe(true);
        });
    });
...
describe('destructuring objects. ', () => {
    ...
    describe('nested', () => {
        ...
        it('array and object', () => {
            const [,[obj]] = [null, [{ env: 'browser', lang: 'ES6' }]];
            const {lang} = obj
