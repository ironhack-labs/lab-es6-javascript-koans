...
describe('`string.includes()` finds string within another string. ', () => {
  ...
  describe('find a single character', function() {
    ...
    it('reports false if character was not found', function () {
      ...
      const expected = searchString.includes('abc');
...
describe('destructuring arrays makes shorter code. ', () => {
  ...
  it('extract from nested arrays', () => {
    ...
    const expected = `${user[0]} ${user[1]} = ${user[2]} years`;
...
describe('destructuring objects. ', () => {
  ...
  describe('nested', () => {
    ...
    it('object and array', () => {
      ...
      // expect(x).toEqual(42); // NO SABEMOS RESOLVERLO
    ...
    it('array and object', () => {
      ...
      // expect(lang).toEqual('ES6'); // NO SABEMOS RESOLVERLO
...
describe('destructuring can also have default values. ', () => {
  ...
  it('for a missing value', () => {
    ...
    // expect(b).toEqual(2);  // NO SABEMOS RESOLVERLO
