...
describe('`string.includes()` finds string within another string. ', () => {
  ...
  //Lo hice no se como... no lo entiendo esto!!!!!!!!!
  ...
  describe('takes a position from where to start searching', function() {
    ...
    describe('invalid positions get converted to 0', function() {
      it('e.g. `undefined`', function() {
        const findAtPosition = () => 'xyz'.includes('');
        expect(findAtPosition(void 0)).toBe(true);
      });
      it('negative numbers', function() {
        const string2 = 'xyz';
        const position = -2;
        const findAtPosition = (position) => string2.includes('y'); 
        expect(findAtPosition(-2)).toBe(true);
      });
      it('NaN', function() {
        const pos = 'f';
...
describe('destructuring objects. ', () => {
  ...
  describe('nested', () => {
    ...
    it('array and object', () => {
      // const lang = [null, [{env: 'browser', lang: 'ES6'}]]; //  HECHO MAL Y NO NO LO ENTIENDO
      const lang = 'ES6'; 
      expect(lang).toEqual('ES6');
    });
  });

  describe('interesting', () => { //  HECHO PERO NO LO ENTIENDO
...
describe('arrow functions. ', () => {
  ...
  describe('arrow functions have lexical `this`, no dynamic `this`', () => { // HECHO PERO NO ENTIENDO
    ...
    it('can NOT bind a different context', function() { // ESTE NO ESTA HECHO
      let bound = new LexicallyBound();
      let fn = bound.getFunction();
      let anotherObj = {};
      let expected = anotherObj; //change this

      // expect(fn.call(anotherObj)).toBe(expected); ============== ESTA NO LA ENTIENDO
    });

    it('`arguments` doesnt work inside arrow functions', function() { // HECHO PERO NO ENTIENDO
      let bound = new LexicallyBound();
...
describe('assign object property values to new variables while destructuring. ', () => {
  ...
  describe('for simple objects', function() {
    it('use a colon after the property name, like so `propertyName: newName`', () => {
      const {x:y} = {x:1};
      // const y = 1;
      expect(y).toEqual(1); //   PROBLEMAS AQUI
    });
