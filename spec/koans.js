...
describe('`const` is like `let` plus read-only. ', () => {
  ...
  describe('scalar values are read-only', () => {
    ...
    it('string are read-only', () => {
      ...
      if (constString == null || constString == undefined) {
  ...
  describe('takes a position from where to start searching', function() {
    ...
    describe('invalid positions get converted to 0', function() {
      ...
      it('negative numbers', function() {
        const findAtPosition = (pos) => 'xyz'.includes(pos) ? false: true
        expect(findAtPosition(-2)).toBe(true);
      });
      it('NaN', function() {
        const findAtPosition = (pos) => 'xyz'.includes(pos) ? NaN : true;
...
describe('destructuring arrays makes shorter code. ', () => {
  ...
  it('extract from nested arrays', () => {
    ...
    expect(`${firstName.join(' ')} = ${user[0,1]} years`).toEqual(expected);
  });
...
describe('arrow functions. ', () => {
  ...
  class LexicallyBound {
    ...
    getFunction() {
      return () => {
        return new LexicallyBound(), this; /*changes might go here*/
      };
    }
  ...
  describe('used as function parameter', () => {
    it('prefix with `...` to spread as function params', function() {
      ...
      const fn = ([magicA, magicB]) => {
        magicA = () =>{return 0}
        magicNumbers.push(magicA)
        magicB = () =>{return 1}
        magicNumbers.push(magicB)
