...
describe("destructuring objects. ", () => {
  ...
  describe("nested", () => {
    ...
    it("array and object", () => {
      const [hi, [{ env, lang }]] = [null, [{ env: "browser", lang: "ES6" }]];
...
describe("arrow functions. ", () => {
  ...
  describe("arrow functions have lexical `this`, no dynamic `this`", () => {
    it("bound at definition time, use `=>` ", function () {
      ...
      //Right now, when fn is declared it calls the getFunction() which creates a new class,
      //but you want it to return this class (defined in bound).
    });
