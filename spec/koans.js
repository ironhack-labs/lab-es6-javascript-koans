...
describe('`string.includes()` finds string within another string. ', () => {
  ...
  describe('find a string', function() {
    it('that matches exactly', function() {
      ...
      const findSome = text => 'xyz'.includes(text);
...
describe('arrow functions. ', () => {
  ...
  class LexicallyBound {
    ...
    // Returns an anonymous ES6 Arrow function, that returns an instance of the same class
...
describe('class creation', () => {
  ...
  it('anonymous class', () => {
    ...
    let classType;
    if(typeof anonymous.aFunction === "function") classType = "function"; 
